...
syn keyword     cLabel          ZERO_INIT MEMORY_SIZEOF SIZEOF INPUT_SECTIONS TYPE START END WIDTH SECTIONS OUTPUT KEEP_SECTIONS OVERLAY INPUT_SECTION
syn keyword     cString         PM DM RAM
syn keyword	cTodo		contained TODO FIXME XXX

syn match       cNumber        ">\s*\w\+"
syn match       cType          "$\w\+"
